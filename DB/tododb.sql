...
START TRANSACTION;
USE `tododb`;
INSERT INTO `user` (`id`, `email`, `username`, `password`, `enabled`, `role`) VALUES (1, 'shaun@winchester.co.uk', 'shaun', 'NULL', 1, 'NULL');
INSERT INTO `user` (`id`, `email`, `username`, `password`, `enabled`, `role`) VALUES (2, 'liz@winchester.co.uk', 'liz', 'NULL', 1, 'NULL');
